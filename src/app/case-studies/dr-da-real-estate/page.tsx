...
export const metadata = constructMetadata({
  ...
  description: 'How Backlink Bridge improved PropertyVault\'s Domain Rating from 14 to 52 in 90 days through a structured high-authority link building campaign.',
      ...
      <section className="bg-navy py-20 border-b border-navy-light/35">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold font-display text-white tracking-tight leading-tight">
            DR 14 → DR 52 in 90 Days
          </h1>
          <p className="text-[18px] text-slate-300 max-w-2xl leading-relaxed font-medium">
            How Backlink Bridge transformed PropertyVault's backlink profile from a spam-heavy DR 14 to a clean, authoritative DR 52 — driving 787% organic traffic growth in one quarter.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16">
          ...
          <div className="text-[15px] text-slate-600 leading-relaxed space-y-4">
            <p>
              The first priority was not link building — it was cleanup. With a spam score of 14%, adding new links on top of a toxic profile would have minimal impact. We began with a full Ahrefs backlink audit, identifying 23 domains with spam scores above 30% that were actively harming PropertyVault's authority profile.
            </p>
            <p>
